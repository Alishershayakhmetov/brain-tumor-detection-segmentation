...
EPOCH_SCHEDULE_RESTART=int(os.getenv("EPOCH_SCHEDULE_RESTART"))
LEARNING_RATE_ETA_MIN=float(os.getenv("LEARNING_RATE_ETA_MIN"))
EARLY_STOPPING_EPOCH=int(os.getenv("EARLY_STOPPING_EPOCH"))
LEARNING_RATE = float(os.getenv("LEARNING_RATE"))
GRAD_ACCUM_STEPS = int(os.getenv("GRAD_ACCUM_STEPS"))
